...
class Rectangle:
    ...
    def __str__(self):
        ...
        for i in range(0, self.__height):
            displayclass.append(str(self.print_symbol))
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
           Name Function:bigger_or_equal
           Description: that returns the biggest rectangle based on the area
        """
    ...
    def square(cls, size=0):
        """
           ...
           Description: returns a new Rectangle instance with width == height
        """
